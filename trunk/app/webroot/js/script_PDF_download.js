    	...
    	$('#content-form2').append("<p> Enviando.. </p>");
    	  ...
    	  $.ajax({
    	    ...
    	    success: function() {
    	      ...
    	      $('#message').html("<h2>Gracias!. Te enviamos el presupuesto a tu email. Tambien podes descargar en PDF!.</h2>")
    	      .append('<a href="generate_pdf" target="_self" class="transition-back"> DESCARGAR</a>')
    	      .hide()
    	      .fadeIn(1500);
    	    }
    	  });
