	...
	<div id="wrap">
		<div id="content">
			...
			<div id="content-upper-left">
				...
				<?php echo $this->Html->link($this->Html->image("back-arrow.png", array("alt" => "Volver", 'height' => '120px', 'width' => '120px', 'id' => 'back-arrow')), array('controller' => 'carteles', 'action' => "front_light"), array('escape' => false, 'class' => 'transition-back', 'title' => "Volver")); ?>	
			</div>
			<div id="content-lower-menu">
				...
				<?php echo $this->Html->link(
					...
					array('controller' => 'carteles', 'action' => "front_light" ,'ya_poseo', 'sin_mantenimiento'),
				...
				<?php echo $this->Html->link(
					...
					array('controller' => 'carteles', 'action' => "front_light" ,'ya_poseo', 'con_mantenimiento'),
					array('target' => '_self', 'escape' => false, 'class' => "transition-out")
					);
				?>	
			</div>
