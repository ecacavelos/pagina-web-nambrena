	...
	<div id="wrap">
		<div id="content">
			...
			<div id="content-upper-left">
				...
				?>
				<!--<img src="images/header_small.sobreposte.png" width="460" height="201" alt="">-->
			...
			<div id="content-lower-menu">
				...
				<?php echo $this->Html->link(
					...
					array('controller' => 'carteles', 'action' => "back_light" ,'sobre_poste', 'una_cara'),
				...
				<?php echo $this->Html->link(
					...
					array('controller' => 'carteles', 'action' => "back_light" ,'sobre_poste', 'doble_cara'),
					array('target' => '_self', 'escape' => false, 'class' => "transition-out")
					);
				?>	
			</div>
