	...
	<div id="wrap">
		<div id="content">
			...
			<div id="content-upper-left">
				...
				?>	
				<!--<a href="carteles_adhesivo.html" class="transition-back"><img src="images/header_small.adhesivo.png" width="442" height="201" alt=""></a>-->
				<?php echo $this->Html->link(
			...
			<div id="content-lower-menu">
				...
				<?php echo $this->Html->link(
					...
					array('controller' => 'carteles', 'action' => "adhesivos" ,'sobre_pared', 'sin_luz'),
				...
				<?php echo $this->Html->link(
					...
					array('controller' => 'carteles', 'action' => "adhesivos" ,'sobre_pared', 'con_luz'),
					array('target' => '_self', 'escape' => false, 'class' => "transition-out")
					);
				?>	
			</div>
